...
const (
	...
	Code_INVALID_CLIENT_PROPERTIES Code = 40021
...
var (
	Code_name = map[int32]string{
		...
		40021: "INVALID_CLIENT_PROPERTIES",
		40100: "UNAUTHORIZED",
...
type Settings struct {
	...
	ClientProperties map[string]string `protobuf:"bytes,9,rep,name=client_properties,json=clientProperties,proto3" json:"client_properties,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *Settings) GetClientProperties() map[string]string {
	if x != nil {
...
const file_apache_rocketmq_v2_definition_proto_rawDesc = "" +
	...
	"\bhostname\x18\x04 \x01(\tR\bhostname\"\x9b\x06\n" +
	"\bSettings\x12D\n" +
	...
	"\x06metric\x18\b \x01(\v2\x1a.apache.rocketmq.v2.MetricR\x06metric\x12_\n" +
	"\x11client_properties\x18\t \x03(\v22.apache.rocketmq.v2.Settings.ClientPropertiesEntryR\x10clientProperties\x1aC\n" +
	"\x15ClientPropertiesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\x12ILLEGAL_LITE_TOPIC\x10Ը\x02\x12\x1f\n" +
	"\x19INVALID_CLIENT_PROPERTIES\x10ո\x02\x12\x12\n" +
...
var file_apache_rocketmq_v2_definition_proto_msgTypes = make([]protoimpl.MessageInfo, 24)
var file_apache_rocketmq_v2_definition_proto_goTypes = []any{
	...
	nil,                           // 37: apache.rocketmq.v2.Settings.ClientPropertiesEntry
...
var file_apache_rocketmq_v2_definition_proto_depIdxs = []int32{
	...
	38, // 3: apache.rocketmq.v2.ExponentialBackoff.initial:type_name -> google.protobuf.Duration
	38, // 4: apache.rocketmq.v2.ExponentialBackoff.max:type_name -> google.protobuf.Duration
	38, // 5: apache.rocketmq.v2.CustomizedBackoff.next:type_name -> google.protobuf.Duration
	...
	39, // 19: apache.rocketmq.v2.SystemProperties.born_timestamp:type_name -> google.protobuf.Timestamp
	39, // 20: apache.rocketmq.v2.SystemProperties.store_timestamp:type_name -> google.protobuf.Timestamp
	39, // 21: apache.rocketmq.v2.SystemProperties.delivery_timestamp:type_name -> google.protobuf.Timestamp
	38, // 22: apache.rocketmq.v2.SystemProperties.invisible_duration:type_name -> google.protobuf.Duration
	38, // 23: apache.rocketmq.v2.SystemProperties.orphaned_transaction_recovery_duration:type_name -> google.protobuf.Duration
	...
	38, // 34: apache.rocketmq.v2.Settings.request_timeout:type_name -> google.protobuf.Duration
	...
	37, // 39: apache.rocketmq.v2.Settings.client_properties:type_name -> apache.rocketmq.v2.Settings.ClientPropertiesEntry
	18, // 40: apache.rocketmq.v2.Publishing.topics:type_name -> apache.rocketmq.v2.Resource
	18, // 41: apache.rocketmq.v2.Subscription.group:type_name -> apache.rocketmq.v2.Resource
	19, // 42: apache.rocketmq.v2.Subscription.subscriptions:type_name -> apache.rocketmq.v2.SubscriptionEntry
	38, // 43: apache.rocketmq.v2.Subscription.long_polling_timeout:type_name -> google.protobuf.Duration
	21, // 44: apache.rocketmq.v2.Metric.endpoints:type_name -> apache.rocketmq.v2.Endpoints
	13, // 45: apache.rocketmq.v2.OffsetOption.policy:type_name -> apache.rocketmq.v2.OffsetOption.Policy
